...
class HCIDataset:
    ...
    def __init__(self, target, date, instrument, coordinates=None):
        ...
        self._number_of_candidates = 0

        # setup data information
        # self._data_info = HCIExtension('BINTABLE', 'DATA_INFORMATION')
        
        # c1  = table.Column(name='Image_Number', format='K', unit='', dtype='int16')
        # c2  = table.Column(name='Orientation', format='D', unit='deg. e of n', dtype='float64')
        # c3  = table.Column(name='Combined_rotation_angle', format='D', unit='deg.', dtype='float64')
        # c4  = table.Column(name='Number_of_Exposures', format='K', unit='', dtype='int16')
        # c5  = table.Column(name='Exposure_Time', format='D', unit='sec', dtype='float64')
        # c6  = table.Column(name='Observation_Start', format='D', unit='Mod. Julian Date', dtype='float64')
        # c7  = table.Column(name='Observation_End', format='D', unit='Mod. Julian Date', dtype='float64')
        # c8  = table.Column(name='UT_Midpoint_Date_of_Observation', format='A10', unit='yyyy-mm-dd', dtype='a20')
        # c9  = table.Column(name='UT_Midpoint_Time_of_Observation', format='A8', unit='hh:mm:ss', dtype='a20')
        # c10 = table.Column(name='Wavelength', format='D', unit='nm', dtype='float64')
        # c11 = table.Column(name='Bandwidth', format='D', unit='nm', dtype='float64')
        # c12 = table.Column(name='Polarization', format='A2', unit='', dtype='a20')
        # data_info_table = table.Table()
        # data_info_table.add_columns([c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12])
        
        # self._data_info.data = data_info_table
    ...
    def readfrom(self, filepath):
        '''
        Read an HCI dataset from an HCI-FITS file
        '''
    ...
    def writeto(self, filepath):
        '''
        Write an HCI dataset to an HCI-FITS file
        '''
        
        pass

    
    def insertDataInformation():
        pass
